...
{
    public GameObject _healthIconPrefab; // the prefab to use.
    public Vector2 _spawnPosition; // it's start position
    public float _positionOffest = 530f; // offset in UI space
    public bool _spawnLeft = true; // Are we spawning left or right.
    List<GameObject> _healthIcons = new List<GameObject>(); // the list we'll use for our health icons.
