...
{
    [SerializeField] private GameObject _pauseMenu = null; //save a reference to our pause menu canvas

    private bool paused = false; // a reference if we're paused or not.
    ...
    public void LoadLevel(string lvlName) // here we're loading a scene by it's name, for everything else.
    {
